      ...
      <div className="animate-in fade-in slide-in-from-bottom-4 duration-700 pb-20">
        {!isSupabaseConfigured && (
          <div className="mb-8 bg-amber-50 border border-amber-200 rounded-2xl p-6 flex items-start gap-4 shadow-sm">
            ...
            <div>
              <h3 className="text-amber-800 font-bold text-sm mb-1">尚未設定 Supabase (Supabase Not Configured)</h3>
            ...
            <section className="bg-surface border border-border rounded-3xl p-8 shadow-sm">
              <div className="flex justify-between items-center mb-6 border-b border-border/50 pb-4">
                <div>
                  ...
                  <p className="text-xs font-mono text-muted uppercase tracking-widest">Leadership_History_CRUD</p>
                </div>
        ...
        {activeTab === "ROLES" && (
          <div className="space-y-12">
            ...
            <section className="bg-surface border border-border rounded-3xl p-8 shadow-sm">
              <SectionHeader title="幹部職責說明管理" subtitle="Roles_&_Responsibilities_CMS" />
        ...
        {activeTab === "LEVELS" && (
          <div className="space-y-12">
            <section className="bg-surface border border-border rounded-3xl p-8 shadow-sm">
              <SectionHeader title="活動分級說明管理" subtitle="Activity_Difficulty_Grading" />
